...
void ConfigManipulation::toggle_print_fff_options(DynamicPrintConfig *config, const bool is_global_config)
{
    ...
    toggle_line("spiral_mode_sinusoidal", has_spiral_vase);
    toggle_line("spiral_mode_sinusoidal_amplitude", has_spiral_vase && config->opt_bool("spiral_mode_sinusoidal"));
    toggle_line("spiral_mode_sinusoidal_waves_per_revolution", has_spiral_vase && config->opt_bool("spiral_mode_sinusoidal"));
