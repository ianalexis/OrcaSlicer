...
static std::vector<std::string> s_Preset_print_options {
    "layer_height", "initial_layer_print_height", "wall_loops", "alternate_extra_wall", "slice_closing_radius", "spiral_mode", "spiral_mode_smooth", "spiral_mode_max_xy_smoothing", "spiral_mode_sinusoidal", "spiral_mode_sinusoidal_amplitude", "spiral_mode_sinusoidal_wavelength", "spiral_starting_flow_ratio", "spiral_finishing_flow_ratio", "slicing_mode",
